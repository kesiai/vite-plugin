...
const ENTRIES: Entry[] = [
  ...
  { label: '改属性(POST)', method: 'POST', path: '/__editor/node/{nodeId}/props', hint: '{ "props": [{ "name": "size", "value": "lg" }] }', pageParam: false },
  { label: '改文本(POST)', method: 'POST', path: '/__editor/node/{nodeId}/children/text', hint: '{ "text": "新文本" }', pageParam: false },
